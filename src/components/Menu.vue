<template>
    <v-navigation-drawer persistent dark v-model="drawer" class="white" height="95%" mini-variant.sync="false" >
        <v-toolbar flat class="transparent">
          <v-list class="pa-0">
            <v-list-tile avatar tag="div" class="indigo darken-4 my-1 py-3">
              <v-list-tile-content>
